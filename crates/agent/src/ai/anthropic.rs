...
fn build_prompt(ctx: &DecisionContext<'_>) -> String {
    ...
    let posture_section = crate::ai::posture_prompt_section(&ctx.host_posture);
    let prior_section = crate::ai::prior_decisions_prompt_section(&ctx.prior_decisions);
...
INCIDENT:
{incident_json}
{graph_section}{playbook_section}{dshield_section}{posture_section}{prior_section}
